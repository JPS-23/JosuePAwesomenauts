...
<html>
	...
	<body>
		<!-- Canvas placeholder -->
		<div id="screen"></div> <!-- this contains everything we see on the screen -->
                ...
                <form id="input" method="post">
                    ...
                    <button type='button' id='register'>Register</button><!--these buttons-->
                    <button type='button' id='load'>Load</button><!--are for our screen-->
		...
		<script type="text/javascript" src="js/screens/play.js"></script>
                ...
                <script type="text/javascript" src="js/screens/loadProfile.js"></script><!-- the game looks for these -->
                <script type="text/javascript" src="js/screens/newProfile.js"></script><!-- To load them in the game -->
		<!-- /build -->
