    ...
    setBuyText: function(){
      game.data.buytext = new (me.Renderable.extend({
        ...
        //These lines of code are for the spendExp screen
            ...
            this.font.draw(renderer.getContext(), "Q Ability: Speed Burst. Current Level: " + game.data.exp4 + " Cost: " + ((game.data.ability1+1)*10), this.pos.x, this.pos.y + 160);
            this.font.draw(renderer.getContext(), "W Ability: Eat Your Creep For Health: " + game.data.exp5 + " Cost: " + ((game.data.ability2+1)*10), this.pos.x, this.pos.y + 200);
            this.font.draw(renderer.getContext(), "E Ability: Throw Your Spear: " + game.data.exp6 + " Cost: " + ((game.data.ability3+1)*10), this.pos.x, this.pos.y + 240);
        }
